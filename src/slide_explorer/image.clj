...
(defn insert-quadrant!
  "Modifies an existing ImageProcessor, dest, by
   inserting a tile into one of its quadrants."
...
(defn insert-quadrant
  "Creates a new ImageProcessor, which is the same
